...
main: arg.o arg_handler.o command_processor.o config.o shell.o command_parser.o
	$(CC) arg.o arg_handler.o command_processor.o config.o command_parser.o shell.o src/main.c $(CFLAGS) -o shell
